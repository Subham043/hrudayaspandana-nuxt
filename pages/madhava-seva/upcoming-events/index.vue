                            ...
                            <div class="event-col-inner">
                                ...
                                <div class="event-text">
                                    <h4 style="text-transform: uppercase">
                                        <img src="/images/om.png" /><NuxtLink :to="`/madhava-seva/upcoming-events/${item.id}`">{{ item.name }}</NuxtLink>
                                    </h4>
                                    ...
                                    <NuxtLink :to="`/madhava-seva/upcoming-events/${item.id}`" class="event-link">Learn More <i class="el-icon-right"></i></NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
